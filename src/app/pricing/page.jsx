...
const page = () => {
  ...
  return (
    <div className='bg-neutral-100 flex flex-col items-center justify-center'>
        <div className='flex flex-col justify-center items-center text-center mb-[1.5rem]'>
            <h1 className='text-[1.875rem] sm:text-[2.25rem] md:text-[3rem] lg:text-[4rem] text-neutral-800 font-semibold'>Plans & Pricing</h1>
            <p className='text-[1rem] sm:text-[1.125rem] md:text-[1.25rem] lg:text-[1.5rem] text-neutral-500 text-center '>Flexible plans to fit your business needs, whether you’re just <br /> starting or scaling up </p>
        </div>

        {/* the switch section */}
        <div className='border-2 mb-[2.8125rem] rounded-full border-neutral-200 bg-[#e7e7e7] w-[23.0625rem] h-[3.5rem]'>
        ...
        {/* the cards section */}
        {buttonOne === "buttonOne" && (
            <div className='max-w-[70.5625rem] w-full grid lg:grid-cols-3 grid-cols-1 gap-4 p-4'>
                <div id='linkOne' onClick={()=> setShowBlue("linkOne")} className={`flex flex-col ${showBlue === "linkOne" ? "bg-[#1A71F6] text-white" :"bg-white"} rounded-xl p-4 max-w-[22.438rem] border border-neutral-100 `}>
                    ...
                    <button className={`border-[2px] rounded-full ${showBlue === "linkOne" ?"text-[#0080FF] bg-white" : "text-[#0080FF] border-[#0080FF]"}   font-semibold text-[1.25rem] py-3 mt-[2.25rem]`}>
                        Get Basic
                    </button>
                ...
                <div id='linkTwo' onClick={()=> setShowBlue("linkTwo")} className={`flex flex-col ${showBlue === "linkTwo" ? "bg-[#1A71F6] text-white" :"bg-white"} rounded-xl p-4 max-w-[22.438rem] border border-neutral-100 `}>
                    ...
                    <button className={`border-[2px] rounded-full ${showBlue === "linkTwo" ?"text-[#0080FF] bg-white" : "text-[#0080FF] border-[#0080FF]"} font-semibold text-[1.25rem] py-3 mt-[2.25rem]`}>
                        Get Plus
                    </button>
                ...
                <div id='linkThree' onClick={()=> setShowBlue("linkThree")} className={`flex flex-col ${showBlue === "linkThree" ? "bg-[#1A71F6] text-white" :"bg-white"} rounded-xl p-4 max-w-[22.438rem] border border-neutral-100 `}>
                    ...
                    <button className={`border-[2px] rounded-full ${showBlue === "linkThree" ?"text-[#0080FF] bg-white" : "text-[#0080FF] border-[#0080FF]"}   font-semibold text-[1.25rem] py-3 mt-[2.25rem]`}>
                        Get Prime
                    </button>
