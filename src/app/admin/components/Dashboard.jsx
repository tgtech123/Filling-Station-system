...
const Dashboard = () => {
  ...
  return (
    <div className='p-4 sm:p-6 lg:p-8'>
      <h1 className='text-xl sm:text-2xl lg:text-[28px] font-semibold leading-[100%] mb-[0.8rem]'>
        General Admin Dashboard
      </h1>
      <p className='text-sm sm:text-base lg:text-[1.125rem] text-neutral-500 leading-[100%]'>
