...
import { X, MapPin, User, Phone, Pause, Trash2, Mail, CalendarDays } from "lucide-react";
import { BsToggleOn, BsToggleOff } from "react-icons/bs";
import { TbTargetArrow } from "react-icons/tb";
import { MdLockReset } from "react-icons/md";
import Image from "next/image";

const ActivateActionModal = ({isOpen, onClose}) => {
            ...
            <div className="flex flex-col gap-2 mb-4 ">
              <div className="flex gap-7">
                  <span className="flex gap-2">
                    <Mail size={24} />
                    <h1 className="text-[1rem] font-medium text-[#616161]"> john.doe@company.com</h1>
                  </span>
                  <span className="flex gap-2">
                    <Phone  size={24} />
                    <h1 className="text-[1rem] font-medium text-[#616161]">+234 9030 203547</h1>
                  </span>
              </div>
    
              <span className="flex gap-3">
                <CalendarDays size={24} />
                <h1 className="text-[1rem] font-medium text-[#616161]">Registered Dec. 2025</h1>
              </span>
            ...
            <div className="border-t-[2px] p-2 lg:p-4 border-b-[2px] border-gray-200">
                  ...
                  <div className=" grid lg:grid-cols-2 grid-cols-1 ">
                      <span className="flex flex-col gap-1 ">
                        ...
                        <span className="text-[0.895rem] font-semibold leading-[140%]">Dickson</span>
                      </span>
                      ...
                      <span className="flex flex-col gap-1 ">
                        ...
                        <span className="text-[0.895rem] font-semibold leading-[140%]">johhn.doe@gmail.com</span>
                      </span>
                      <span className="flex flex-col gap-1 ">
                        <span className="text-[#616161] text-[0.875rem]">Phone</span>
                        <span className="text-[0.895rem] font-semibold leading-[140%]">+90 243 5645394</span>
                      </span>
                  </div>
            </div>
                  ...
                  <div className="border-b-[2px] border-gray-200 lg:p-4 p-2">
                    ...
                    <div className="mt-[1rem] grid lg:grid-cols-2 grid-cols-1 ">
                      <span className="flex flex-col gap-1 ">
                        ...
                        <span className="text-[1rem] font-semibold bg-[#F3F5F9] rounded-2xl w-[61px] h-[32px] text-[#0156D1] text-center flex items-center justify-center ">Prime</span>
                      </span>
                      <span className="flex flex-col mb-[1rem] gap-1 ">
                        <span className="text-[#616161] text-[0.795rem]">Status</span>
                        <span className="text-[1rem] font-semibold bg-[#F1F9F1] rounded-2xl w-[61px] h-[32px] text-[#07834B] text-center flex items-center justify-center ">Prime</span>
                      </span>
                      <span className="flex flex-col gap-1 ">
                        <span className="text-[#616161] text-[0.785rem]">December 1, 2024</span>
                        <span className="text-[0.895rem] font-semibold leading-[140%]">johhn.doe@gmail.com</span>
                      </span>
                      <span className="flex flex-col gap-1 ">
                        <span className="text-[#616161] text-[0.785rem]">Expiry</span>
                        <span className="text-[0.895rem] font-semibold leading-[140%]">December 1, 2025</span>
                      </span>
                    </div>
                    ...
                    <div className="flex gap-3 items-center ">
                      <div className="bg-[#FFF1F3] rounded-md h-[2.5rem] w-[2.5rem] flex items-center justify-center ">
                       ...
                       <div>
                        ...
                        <p className="text-neutral-500 text-[0.875rem] font-medium">Manage this station’s account and subscription</p>
                       </div>
                    </div>
                  </div>
    
                  <div className="mt-[1.235rem] flex flex-col gap-4">
                    <button className="flex gap-2 items-center cursor-pointer justify-center text-[#F57C00] border-[1px] border-[#F57C00] w-full py-2 rounded-full text-[0.875rem] font-medium">
                      <Pause  size={18}/>
