    ...
    try {
      await new Promise((resolve, reject) => {
        setTimeout(() => {
          ...
          isSuccess ? resolve() : reject(new Error("Activation failed"));
        }, 1000);
      });
        ...
        <div>
          ...
          <div className="mt-[1.235rem] flex flex-col gap-4">
            <button
              ...
              disabled={isLoading}
              className="flex gap-2 items-center cursor-pointer justify-center text-[#1A71F6] border-[1px] border-[#1A71F6] w-full py-2 rounded-full text-[0.875rem] font-medium"
            >
              <Play size={18} />
             {isLoading ? "Activating....." : "Activate Station"}
            </button>
            <button onClick={()=> setIsResetOpen(true)} className="flex gap-2 items-center cursor-pointer justify-center border-[1px] border-[#D0D5DD] w-full py-2 rounded-full text-[0.875rem] font-medium">
              <MdLockReset size={18} />
