...
async function handler(req) {
  ...
  const url = `${process.env.NEXT_PUBLIC_API || "https://fueldesk-station-server.onrender.com"}/api/admin/settings${search}`;
  ...
  try {
    ...
    console.error("âŒ /api/admin/settings proxy error:", err.message);
