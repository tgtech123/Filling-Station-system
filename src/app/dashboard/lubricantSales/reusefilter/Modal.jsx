...
const Modal = ({ isOpen, onClose }) => {
  const [isFilterOpen, setIsFilterOpen] = useState(false);
  const [salesData, setSalesData] = useState([]); // fetched from API
  ...
  // ✅ Apply filters (works with real data)
  const handleApplyFilter = (filters) => {
        ...
        <div className="flex-1 mb-4">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Print and export all sales receipts
            </p>
          </div>
          ...
          <div className="flex justify-between py-3 flex-col sm:flex-row gap-2">
            ...
            <div className="relative">
              ...
              <GrSearch
                size={22}
                className="absolute top-3 text-neutral-400 right-3"
              />
            </div>
            ...
            <div className="relative flex gap-3">
              ...
              {toggleChevron && (
                <div className="absolute z-50 top-14 bg-white border-2 rounded-lg w-fit p-3">
                  ...
                  <div className="flex flex-col gap-2 mt-3">
                    {["Today", "This week", "This month", "This quarter"].map(
                      (range) => (
                        <button
                          key={range}
                          className="border-2 border-neutral-200 hover:bg-blue-600 hover:text-white font-semibold p-2 rounded-lg hover:shadow-md"
                        >
                          {range}
                        </button>
                      )
                  ...
                  <hr className="border-[1px] mt-2" />
                  <span className="flex justify-center cursor-pointer p-2 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-500">
                    <button onClick={handleChevron}>Save</button>
                  </span>
                </div>
              )}
