...
const CustomTable = ({
      ...
      case "pending":
        return (
          <div className="flex items-center gap-2">
            {/* ✅ Click this to mark as completed */}
            <button
              onClick={() =>
                onStatusAction && onStatusAction("complete", row, rowIndex)
              }
            ...
            <button
              onClick={() =>
                onStatusAction && onStatusAction("edit", row, rowIndex)
              }
            ...
            <button
              onClick={() =>
                onStatusAction && onStatusAction("delete", row, rowIndex)
              }
  ...
  const renderLastColumnCell = (cell, row, cellIndex, rowIndex) => {
    if (renderLastColumn) return renderLastColumn(cell, row, rowIndex);
    if (lastColumnType === "status") return renderStatusCell(cell, row, rowIndex);
    return cell;
  };
