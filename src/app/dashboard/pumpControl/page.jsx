...
import { X, ArrowLeft, Wrench } from "lucide-react";
    ...
    <div className="bg-gray-100 min-h-screen">
      <header className="px-4 lg:px-[40px] mb-10 bg-white shadow-sm h-[170px] lg:h-[90px] flex flex-col lg:flex-row gap-4 lg:gap-0 items-center justify-center lg:justify-between">
        ...
        <div className="flex gap-2 items-center">
          <button className="text-sm lg:text-md cursor-pointer border-3 flex gap-2 items-center border-[#f00] hover:bg-[#f00] hover:text-white py-2 px-6 rounded-[12px] text-[#f00]">
            Emergency Stop All
       ...
       <div className="px-6 lg:px-[40px]">
        ...
        <div className="px-6 lg:px-[40px] mt-4">
              <PumpDisplay />
        </div>
    </div>
  );
