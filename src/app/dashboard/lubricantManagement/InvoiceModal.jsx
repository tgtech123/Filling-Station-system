...
//   // fallback in case no invoice passed
//   const inv = invoice || {
//     invoiceNo: "#0000",
...
//   const rowAmount = (r) => {
//     // some items may have sellingPrice
//     return r.amount || r.quantity * r.unitCost;
//   };
...
//             </div>
//             <div className="flex flex-col items-end">
//               <p className="font-medium text-sm">{inv.cashier || "N/A"}</p>
//               <p className="font-medium text-sm">{inv.supplier}</p>
...
//                     <td className="px-4 py-4 text-sm font-medium">{r.productName || r.name}</td>
//                     <td className="px-4 py-4 text-sm">{formatNgn(rowAmount(r))}</td>
//                     <td className="px-4 py-4 text-sm">{r.quantity || r.qty}</td>
