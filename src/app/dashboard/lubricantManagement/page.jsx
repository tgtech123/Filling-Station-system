    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="mt-10 px-6 lg:px-[40px] flex flex-col text-sm lg:text-md gap-3 lg:gap-0 lg:flex-row justify-between items-start lg:items-center">
        <div className="bg-white border-2 border-gray-300 flex gap-4 py-2 px-6 rounded-[10px]">
            <div id="Lubricant sales" onClick={() => handleClick("Lubricant sales")}  className={`px-6 py-2 rounded-[8px] cursor-pointer ${activeTab === "Lubricant sales" ? "bg-[#d9edff] font-semibold text-[#0080ff]" : "bg-transparent text-inherit"} flex gap-2`}>
                <House />
                Lubricant sales
            </div>
            <div id="Inventory" onClick={() => handleClick("Inventory")} className={`px-6 py-2 rounded-[8px] cursor-pointer ${activeTab === "Inventory" ? "bg-[#d9edff] font-semibold text-[#0080ff]" : "bg-transparent text-inherit"} flex gap-2`}>
                <House />
                Inventory
            </div>
        </div>
