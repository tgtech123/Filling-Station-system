    ...
    <div className="bg-gray-100 dark:bg-gray-950 min-h-screen">
      <header className="px-4 lg:px-[40px] mb-10 bg-white dark:bg-gray-900 shadow-sm h-[150px] lg:h-[90px] flex flex-col lg:flex-row gap-4 lg:gap-0 items-center justify-center lg:justify-between">
        <div className="mt-2 lg:mt-0 flex flex-col lg:flex-row gap-1 lg:gap-4 items-center">
          <Link
            href="/dashboard"
            className="cursor-pointer border-3 hover:scale-105 transition flex text-[1rem] lg:text-[1.325rem] items-center gap-2 border-none lg:border-[#0080ff] py-2 px-6 rounded-[12px] text-[#0080ff] font-semibold"
          >
            <ArrowLeft size={28} />
            Back to Dashboard
          </Link>
      ...
      {/* ── Global export error banner  */}
      {exportError && (
        <div className="mx-6 lg:mx-[40px] mb-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-center justify-between">
          <span className="text-sm font-medium">{exportError}</span>
          <button
            onClick={() => clearError("export")}
            className="text-red-500 hover:text-red-700 font-bold text-xl leading-none ml-4"
          >
            ×
          </button>
        </div>
      ...
      <div className="px-6 lg:px-[40px]">
        <DisplayCard>
          ...
          <p className="text-gray-500 mb-2">Generate and export comprehensive station reports</p>
...
// import DisplayCard from "@/components/Dashboard/DisplayCard";
// import { ArrowLeft, Download, FileText, Loader2, RefreshCw, UserRoundPen } from "lucide-react";
// import Link from "next/link";
// import { reportType } from "./exportReportData";
// import ExportReportCard from "./ExportReportCard";
// import CustomReportBuilder from "./CustomReportBuilder";
...
//         <div className="mt-2 lg:mt-0 flex lg:flex-row lg:gap-4 items-center justify-between">
//           <div className="flex gap-7 items-center">
//             <Link
//               href="/dashboard"
//               className="cursor-pointer text-[1.75rem] hover:scale-105 transition border-3 flex gap-2 items-center border-none lg:border-[#0080ff] py-2 px-6 rounded-[12px] text-[#0080ff] font-semibold"
//             >
//               <ArrowLeft size={35} />
//               Back to Dashboard
//             </Link>
...
//             className="cursor-pointer text-[1.25rem] border-2 border-neutral-400 p-2 font-bold text-[#0080ff] hover:underline"
//           >
//             View Profile
//             <UserRoundPen  />
//           </button>
